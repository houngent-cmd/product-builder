...
- **Real-time News Feed**: Fetches the latest 5 posts from the "uspolitics" DC Inside gallery every 60 seconds. Uses multiple CORS proxy fallbacks (AllOrigins, CORSProxy.io) and cache-busting to ensure high reliability.
